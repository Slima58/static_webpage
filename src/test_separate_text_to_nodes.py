import unittest
from separate_text_to_nodes import text_to_textnodes, markdown_inline_parser
from textnode import TextNode, TextType

class TestTextMarkdownParse(unittest.TestCase):
    def test_separate_text_to_nodes(self):
